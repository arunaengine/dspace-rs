...
pub async fn create_policy_definition(
    ...
    policy_definition_input: Option<edc_api::PolicyDefinitionInput>,
) -> Result<edc_api::IdResponse, Error<CreatePolicyDefinitionError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePolicyDefinitionError> =
...
pub async fn delete_policy_definition(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<(), Error<DeletePolicyDefinitionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePolicyDefinitionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_policy_definition(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<edc_api::PolicyDefinitionOutput, Error<GetPolicyDefinitionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPolicyDefinitionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn query_policy_definitions(
    configuration: &configuration::Configuration,
    query_spec: Option<edc_api::QuerySpec>,
) -> Result<Vec<edc_api::PolicyDefinitionOutput>, Error<QueryPolicyDefinitionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<QueryPolicyDefinitionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_policy_definition(
    ...
    id: &str,
    policy_definition_input: Option<edc_api::PolicyDefinitionInput>,
) -> Result<(), Error<UpdatePolicyDefinitionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePolicyDefinitionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
