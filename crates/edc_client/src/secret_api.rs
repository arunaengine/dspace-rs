...
pub async fn update_secret(
    ...
    secret_input: Option<edc_api::SecretInput>,
) -> Result<(), Error<UpdateSecretError>> {
...
pub async fn create_secret(
    configuration: &configuration::Configuration,
    secret_input: Option<edc_api::SecretInput>,
) -> Result<edc_api::IdResponse, Error<CreateSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_secret(
    configuration: &configuration::Configuration,
    secret_id: &str,
) -> Result<edc_api::SecretOutput, Error<GetSecretError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_secret(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
