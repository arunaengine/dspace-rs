...
async fn main() {
    ...
    let management_catalog_route = Router::new()
        ...
        .route("/datasets/request", post(management_catalog::request_catalog_dataset))
    ...
    let management_contract_agreement_route = Router::new()
        ...
        .route("/request", post(management_contract_agreement::request_agreements))
        ...
        .route("/:id/negotiation", get(management_contract_agreement::get_agreement_negotiation))
    ...
    let management_contract_definitions_route = Router::new()
        ...
        .route("/:id", delete(management_contract_definition::delete_contract_definition))
    ...
    let management_contract_negotiations_route = Router::new()
        ...
        .route("/", post(management_contract_negotiation::initiate_contract_negotiation))
        // `POST /v2/contractnegotiations/request` goes to `request_contract_negotiation`
        .route("/request", post(management_contract_negotiation::request_contract_negotiation))
        // `GET /v2/contractnegotiations/{id}` goes to `get_contract_negotiation`
        .route("/:id", get(management_contract_negotiation::get_contract_negotiation))
        // `GET /v2/contractnegotiations/{id}/agreement` goes to `get_agreement_by_negotiation_id`
        .route("/:id/agreement", get(management_contract_negotiation::get_agreement_by_negotiation_id))
        // `GET /v2/contractnegotiations/{id}/state` goes to `get_negotiation_state`
        .route("/:id/state", get(management_contract_negotiation::get_negotiation_state))
        // `POST /v2/contractnegotiations/{id}/terminate` goes to `terminate_contract_negotiation`
        .route("/:id/terminate", post(management_contract_negotiation::terminate_contract_negotiation))
        // add shared state to the app
    ...
    let management_policy_definition_route = Router::new()
        ...
        .route("/", post(management_policy_definition::create_policy_definition))
        // Request Policy Definitions
        // `POST /v2/policydefinitions/request` goes to `request_policy_definitions`
        .route("/request", post(management_policy_definition::request_policy_definitions))
        // Get a Policy Definition
        // `GET /v2/policydefinitions/{id}` goes to `get_policy_definition`
        .route("/:id", get(management_policy_definition::get_policy_definition))
        // Update a Policy Definition
        // `PUT /v2/policydefinitions/{id}` goes to `update_policy_definition`
        .route("/:id", put(management_policy_definition::update_policy_definition))
        // Delete a Policy Definition
        // `DELETE /v2/policydefinitions/{id}` goes to `delete_policy_definition`
        .route("/:id", delete(management_policy_definition::delete_policy_definition))
    ...
    let management_transfer_process_route = Router::new()
        ...
        .route("/", post(management_transfer_process::initiate_transfer_process))
        // Request Transfer Processes
        // `POST /v2/transferprocesses/request` goes to `request_transfer_processes`
        .route("/request", post(management_transfer_process::request_transfer_processes))
        // Get a Transfer Process
        // `GET /v2/transferprocesses/{id}` goes to `get_transfer_process`
        .route("/:id", get(management_transfer_process::get_transfer_process))
